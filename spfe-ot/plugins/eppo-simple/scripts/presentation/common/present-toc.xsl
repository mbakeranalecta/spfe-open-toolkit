<<<<<<< HEAD:spfe-ot/plugins/eppo-simple/scripts/presentation/common/present-manifest.xsl
...
>>>>>>> parent of edb8f6d... Renamed "toc" to "manifest" because more accurate:spfe-ot/plugins/eppo-simple/scripts/presentation/common/present-toc.xsl
